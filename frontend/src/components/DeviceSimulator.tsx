                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center gap-2.5 min-w-0 flex-1">
                              ...
                              <div className="min-w-0 flex-1">
                                <p className={`font-bold text-[11px] leading-tight break-words capitalize ${isHC ? 'text-slate-950 font-extrabold' : 'text-slate-800'}`}>{evt.label}</p>
                              </div>
                            </div>
                        ...
                        <div key={idx} className={`p-3 rounded-2xl flex items-center justify-between gap-2.5 animate-fadeIn ${
                          ...
                          <div className="flex items-center gap-3 min-w-0 flex-1">
                            ...
                            <div className="text-left min-w-0 flex-1">
                              <div className={`font-bold text-xs leading-snug break-words ${isHC ? 'text-slate-950 font-extrabold' : 'text-slate-800'}`}>{evt.label}</div>
                            </div>
                          </div>
                          <div className="shrink-0">
