...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    Future.microtask(() async {
      ...
      // Do not start the microphone if sound detection is disabled.
        ...
        if (!isListening) {
          ...
          try {
            await _classificationService.startListening((sound, confidence) {
              ...
              currentState.triggerSoundEvent(sound);
            });
          } catch (e) {
                  ...
                  children: [
                    Expanded(
                      child: _buildEnvironmentToggle(
                        ...
                        onTap: () =>
                            state.setEnvironmentMode(EnvironmentType.indoor),
                        isHC: isHC,
                      ),
                    ),
                    Expanded(
                      child: _buildEnvironmentToggle(
                        ...
                        onTap: () =>
                            state.setEnvironmentMode(EnvironmentType.outdoor),
                        isHC: isHC,
                      ),
                    ),
                  ],
                  ...
                  child: Column(
                    children: [
                                ...
                                if (!state.isListening) {
                                  ...
                                  try {
                                    await _classificationService
                                        .startListening((sound, confidence) {
                                      if (!mounted) return;
                                    ...
                                    print(
                                        'Failed to restart sound detection: $e');
                                  }
                                }
                              },
                      ...
                      if (lastSound != null) ...[
                        if (textEnabled) ...[
                          Text(
                            getLocalizedSoundName(lastSound.id,
                                context: context),
                      ...
                      children: [
                        if (iconEnabled) ...[
                          Container(
                            ...
                            child: Icon(
                              _getSoundIconData(evt.soundId.isNotEmpty
                                  ? evt.soundId
                                  : evt.label),
                              size: 18,
                              color: colorEnabled
                                  ? AppColors.getSeverityColor(evt.severity,
                                      highContrast: isHC)
                                  : (isHC
                                      ? AppColors.hcText
                                      : const Color(0xFF475569)),
