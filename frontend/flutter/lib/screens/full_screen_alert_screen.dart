...
class FullScreenAlertScreen extends StatefulWidget {
  ...
  @override
  State<FullScreenAlertScreen> createState() =>
      _FullScreenAlertScreenState();
}

class _FullScreenAlertScreenState
    extends State<FullScreenAlertScreen>
  ...
  void _handleEmergencyContact(
    ...
    final contactPhone =
        state.userProfile.emergencyContactPhone ?? '112';
  ...
  Widget build(BuildContext context) {
    ...
    // --------------------------------------------------------
    // IMPORTANT:
    // Determine priority from the CURRENT environment mode.
    //
    // Indoor  -> indoorSeverity
    // Outdoor -> outdoorSeverity
    // --------------------------------------------------------
    final currentPriority = sound.getPriority(
    ...
    // --------------------------------------------------------
    // Theme color palette matching alert tier
    // --------------------------------------------------------
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: primaryAlertColor.withValues(
                          alpha: 0.2,
                        ),
                        borderRadius:
                          ...
                          Text(
                            isCritical
                                ...
                                : '${_getLocalizedSeverity(currentPriority, l10n)} '
                                    '${l10n.priorityPrefix.toUpperCase()}',
                            style: TextStyle(
                              fontSize: 11,
                ...
                if (textEnabled) ...[
                  ...
                  Text(
                    '${getLocalizedCategoryName(sound.category, context: context).toUpperCase()} • '
                    '${_getLocalizedMode(state.environmentMode, l10n).toUpperCase()}',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 13,
