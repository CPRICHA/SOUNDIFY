...
class _GuideScreenState extends State<GuideScreen>
  ...
  Future<void> _testTier(PriorityLevel severity) async {
    ...
    final duration =
        HapticService.getFallbackDuration(severity);
  ...
  Widget _buildPriorityBadge(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius:
            BorderRadius.circular(compact ? 7 : 10),
        border: Border.all(
        ...
        return StatefulBuilder(
          builder: (bottomCtx, setModalState) {
            final indoorPriority =
                sound.indoorSeverity;

            final outdoorPriority =
                sound.outdoorSeverity;

            final isVib =
                _isVibratingMap[indoorPriority] ??
                    false;
  ...
  Widget build(BuildContext context) {
    ...
    final filteredTaxonomy =
        soundTaxonomy.where((s) {
